    ...
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                //horas = Console.WriteLine();
                //horas = int.Parse(horas);

                while (horas.GetType() != typeof(int) && horas < 0)
                {
                    Console.WriteLine("Horas precisa ser um número inteiro positivo ou zero.");
                    horas = Convert.ToInt32(Console.ReadLine());
                }

                valorTotal = this.precoInicial + (horas * this.precoPorHora);
